...
//Yell Mal'ganis
#define SAY_INTRO_1                                  -1999927
#define SAY_INTRO_2                                  -1999926
#define SAY_OUTRO                                    -1999912
#define SAY_AGGRO                                    -1999925
#define SAY_KILL_1                                   -1999924
#define SAY_KILL_2                                   -1999923
#define SAY_KILL_3                                   -1999922
#define SAY_SLAY_1                                   -1999921
#define SAY_SLAY_2                                   -1999920
#define SAY_SLAY_3                                   -1999919
#define SAY_SLAY_4                                   -1999911
#define SAY_SLEEP_1                                  -1999918
#define SAY_SLEEP_2                                  -1999917
#define SAY_30HEALTH                                 -1999916
#define SAY_15HEALTH                                 -1999915                             
#define SAY_ESCAPE_SPEECH_1                          -1999914         
#define SAY_ESCAPE_SPEECH_2                          -1999913                                   

struct MANGOS_DLL_DECL boss_mal_ganisAI : public ScriptedAI
{
    boss_mal_ganisAI(Creature *c) : ScriptedAI(c) { Reset(); }

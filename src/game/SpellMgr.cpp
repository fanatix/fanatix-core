...
uint8 GetSpellAllowedInLocationError(SpellEntry const *spellInfo,uint32 map_id,uint32 zone_id,uint32 area_id, uint32 bgInstanceId)
{
    ...
    switch(spellInfo->Id)
    {
        ...
        case 58361:                                         // The Might of Mograine
            return area_id == 4281 || area_id == 4342 ? 0 : SPELL_FAILED_INCORRECT_AREA;
        case 58530:                                         // Return to Stormwind (Chapter V)
        case 58551:                                         // Return to Orgrimmar (Chapter V)
            return area_id != 4281 && area_id != 4342 ? 0 : SPELL_FAILED_INCORRECT_AREA;
        case 51915:                                         // Undying Resolve
        case 52598:                                         // Ebon Hold: Chapter II, Skybox
        case 52597:                                         // Chapter II
        case 53107:                                         // Chapter III
        case 53405:                                         // Chapter IV (Epilogue)
        case 53642:                                         // The Might of Mograine
            return map_id == 609 ? 0 : SPELL_FAILED_REQUIRES_AREA;
        case 51852:                                         // The Eye of Acherus
        case 52707:                                         // See Noth Invisibility
        case 52950:                                         // See Chapel Invisibility
        case 53081:                                         // Scarlet Crusade Disguise
            return map_id == 609 && area_id != 4281 && area_id != 4342 ? 0 : SPELL_FAILED_REQUIRES_AREA;

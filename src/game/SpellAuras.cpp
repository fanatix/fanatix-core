        ...
        case SPELLFAMILY_ROGUE:
        {
            ...
            if (spell->Id==31666 && !apply)
            {
                ...
                break;
                       ...
                       // Overkill after stealth break
                       if(spell->Id==58428)
                       {
                               if(apply)
                               {
                                       m_duration = 6000;
                                       m_target->ApplyModInt32Value(UNIT_FIELD_POWER_COST_MODIFIER, (m_modifier.m_amount * -1) ,apply);
                               }
                               else
                                       m_target->ApplyModInt32Value(UNIT_FIELD_POWER_COST_MODIFIER, (m_modifier.m_amount * -1) ,false);
                       }
            break;
        }
        case SPELLFAMILY_HUNTER:
